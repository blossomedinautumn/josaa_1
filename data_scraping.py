...
df = pd.DataFrame(
    list(zip(year, round_no, institutes, branches, quotas, categories, genders, opening_ranks, closing_ranks)),
    columns=['Year', 'Round', 'Institutes', 'Academic Program', 'Quota', 'Seat Type', 'Gender', 'Opening Rank',
             'Closing Rank'])
